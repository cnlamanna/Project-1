...
#PREMISE OF CODE: input certain month, in this case the current month/year, and it pulls the top 3 popular genres
#when I tried to get it to give me just the top 3 for the year, i was getting an "authorization error"
#turns out I need certain professional credentials to get certain information from spotify/spotipy.
#but if i limit the information i want to a certain month it will produce info
# Spotify API client
